...
| | Student A | Student B |
|--|-----------|------------|
| | Knows the rule | Understands the concept |
| | Cannot explain why it works | Can explain their reasoning |
| | Gets stuck if they forget the steps | Can check if their answer makes sense |
...
We recently shared our journey publicly for the first time.

**[Read the thread on X →](https://x.com/padho_ai/status/2022585560712233143)**

We also shared our launch publicly via Hindustan Times Genesis.

![Hindustan Times Genesis coverage](https://res.cloudinary.com/ddgqbftjb/image/upload/v1771146691/Screenshot_2026-02-14_at_3.59.25_PM_d0aqqx.png)
